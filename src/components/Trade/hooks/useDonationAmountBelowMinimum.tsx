import { ethAssetId, thorchainAssetId } from '@gridironx/caip'
    ...
    switch (activeSwapperName) {
      ...
      case SwapperName.OneInch:
        return walletIsKeepKey
          ? // disable EVM donations on KeepKey until https://github.com/incubus-network/web/issues/4518 is resolved
            true
