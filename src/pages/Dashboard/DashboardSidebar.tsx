...
import { btcAssetId, dogeAssetId, merlinAssetId } from '@gridironx/caip'
...
const promoData: PromoItem[] = [
  {
    ...
    image: `url(https://uploads-ssl.webflow.com/5cec55545d0f47cfe2a39a8e/637d3eab8977b9c820ecb3fc_merlin-promo-1.jpg)`,
    startDate: '2023-01-01 08:00 AM',
    endDate: '2023-01-01 08:00 AM',
    id: 'apple-pay',
    href: 'https://widget.onramper.com/?apiKey=pk_prod_ViOib9FcqKQeqqBsLF6ZPYis8X0Wdl9ma16rBhTxXmw0&defaultCrypto=ETH&supportSell=false&isAddressEditable=false&language=en&darkMode=true&redirectURL=https%3A%2F%2Fapp.incubus.network%2F%23%2Fbuy-crypto&onlyGateways=Mercuryo',
  ...
  {
    title: 'plugins.merlinPage.dappBack.title',
    body: 'plugins.merlinPage.dappBack.body',
    cta: 'plugins.merlinPage.dappBack.cta',
    startDate: '2023-03-01 8:00 AM',
    endDate: '2023-03-07 8:00 AM',
    id: 'dappback-promo',
    href: 'https://dappback.com/incubus-network',
    walletRequired: false,
    isExternal: true,
    rightElement: <AssetIcon assetId={merlinAssetId} />,
  },
]
