    ...
    <Main>
      <Flex px={{ base: 2, lg: 4 }} py={{ base: 4, lg: 8 }} direction={'column'} rowGap={4}>
        <DarkMode>
          ...
          <RawText as='p'>WELCOME TO THE DECENTRALIZED INCUBUS-NETWORK PLATFORM!</RawText>
          <RawText as='p'>
            THESE TERMS CONSTITUTE A LEGALLY BINDING AGREEMENT BETWEEN YOU AND THE INCUBUS-NETWORK
            DECENTRALIZED AUTONOMOUS ORGANIZATION (WHO WE REFER TO IN THE FIRST PERSON IN THESE
            TERMS).{' '}
            <RawText as='strong'>
              WE ARE NOT AFFILIATED WITH INCUBUS-NETWORK AG (OR ANY OF ITS AFFILIATES), THE PRIOR OWNER
              AND OPERATOR OF THE INCUBUS-NETWORK PLATFORM.
            </RawText>{' '}
          ...
          <RawText as='dl' display={'flex'} flexDirection={'column'} rowGap={4}>
            ...
            <RawText as='dd' marginInlineStart={{ base: 2, lg: 4 }}>
              ...
              reviewed{' '}
              <Link href='https://github.com/incubus-network/hdwallet'>
                <RawText as='strong'>here</RawText>
              </Link>
          ...
          <RawText as='p'>
            <RawText as='strong'>MERLIN Tokens:</RawText> ShapeShift AG, with whom we are not
            affiliated, created a standard ERC-20 token on the Ethereum blockchain that can be
            accessed through most wallets that support Ethereum called the MERLIN token (each a &quot;
            <RawText as='strong'>MERLIN Token</RawText>&quot;). In spring 2021, ShapeShift AG
            airdropped the majority of its MERLIN Tokens to prior users, members of various DAOs,
            shareholders, employees, and to fund us as a DAO. MERLIN Tokens are used as governance
            tokens for the Platform. Neither we nor ShapeShift AG have ever sold MERLIN Tokens. To
            learn more about how MERLIN Token holders can participate in governance of the Platform,
            please join or discord server{' '}
            <Link href='https://discord.com/invite/shapeshift'>
              <RawText as='strong'>here</RawText>
            </Link>{' '}
            and see the channel titled &quot;governance&quot;. The smart contract for the MERLIN Tokens
            can be found{' '}
          ...
          <RawText as='p'>
            ...
            <Link href='https://github.com/incubus-network/web'>
              <RawText as='strong'>here</RawText>
            </Link>
            ,{' '}
            <Link href='https://github.com/incubus-network/lib'>
              <RawText as='strong'>here</RawText>
            </Link>
            , and{' '}
            <Link href='https://github.com/incubus-network/hightable'>
              <RawText as='strong'>here</RawText>
            </Link>
