 ...
 * from hightable, market apis, or otherwise. it's optimized such that it won't unnecessarily render
 *
...
export const AppProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  useEffect(() => {
    ;(async () => {
      ...
      const { getMerlinRebaseHistoryByAccountId } = txHistoryApi.endpoints
      ...
      requestedAccountIds.forEach(accountId => {
        ...
        switch (chainId) {
          ...
          case ethChainId:
            ...
            /**
             * fetch all rebase history for merlin
             *
             * merlin rebase history is most closely linked to transactions.
             ...
             */
            dispatch(getMerlinRebaseHistoryByAccountId.initiate({ accountId, portfolioAssetIds }))
            break
          default:
        }
      })
  ...
  useEffect(() => {
    ...
    // TODO(0xdef1cafe): bring polling back once we point at markets.incubus.network
