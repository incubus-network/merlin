...
export const merlinTradeOpportunitiesBuckets: TradeOpportunitiesBucket[] = [
  {
    title: 'plugins.merlinPage.dex',
    opportunities: [
      {
      ...
      {
        link: 'https://app.thorswap.finance/swap/ETH.ETH_ETH.MERLIN-0XC770EEFAD204B5180DF6A14EE197D99D808EE52D',
        icon: 'thorswap.png',
      },
    ],
  },
  {
    title: 'plugins.merlinPage.centralized',
    opportunities: [
      {
        link: 'https://www.coinbase.com/price/merlin-token',
        icon: 'coinbase.png',
      },
    ],
  },
