...
import { merlinAssetId, merlinAssetId, fromAccountId, fromAssetId } from '@gridironx/caip'
      ...
      [merlinAssetId]: [
        {
          ...
          opportunities: [
            {
              name: 'ElasticSwap',
              contractAddress: merlinAddresses[0].staking,
              isLoaded: true, // No network request here
              apy: null,
              link: 'https://elasticswap.org/#/liquidity',
              icons: [
                'https://raw.githubusercontent.com/incubus-network/lib/main/packages/asset-service/src/generateAssetData/ethereum/icons/merlin-icon.png',
              ],
            },
          ],
        },
