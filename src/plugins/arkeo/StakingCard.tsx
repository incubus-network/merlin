  ...
  const { title, body, cta } = (() => {
    switch (provider) {
      case DefiProvider.ShapeShift:
        return {
          title: 'arkeo.merlinTokenHolders.title',
          body: 'arkeo.merlinTokenHolders.body',
          cta: 'arkeo.merlinTokenHolders.cta',
        }
      case DefiProvider.EthMerlinStaking:
        return {
          title: 'arkeo.merlinFarmers.title',
          body: 'arkeo.merlinFarmers.body',
          cta: 'arkeo.merlinFarmers.cta',
        }
      default:
        return {
