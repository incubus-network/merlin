...
import { cosmosAssetId, osmosisAssetId } from '@gridironx/caip'
...
import { MerlinTokenHolders } from './MerlinTokenHolders'
...
const MERLIN_STAKING_CONTRACT = 'eip155:1/erc20:0xee77aa3fd23bbebaf94386dd44b548e9a785ea4b'

const opportunities: OpportunityReturn = {
  staking: [
    MERLIN_STAKING_CONTRACT,
    merlinEthStakingAssetIdV6,
    osmosisAssetId,
    cosmosAssetId,
  ] as OpportunityId[],
  lp: [merlinEthLpAssetId, cosmosOsmosLpAssetId],
}
            ...
            <Flex>
              ...
              ${translate('arkeo.whatIsArkeo.bodyParts.1')} `}
                <Link
                  color={linkColor}
                  isExternal
                  href='https://incubus.network/library/merlinchain-shapeshift-partners-with-coinbase-cloud'
                >
      ...
      <Flex gap={4} py={12} flexDir={{ base: 'column', md: 'row' }}>
        ...
        <Flex flexDir='column' gap={4} alignItems='flex-start'>
          ...
          <Button
            ...
            colorScheme='blue'
            size='lg'
            href='https://snapshot.org/#/incubusdao.eth/proposal/0xcc1e83822fc7668a9d9e9136e5bd8973b7dc1ed766c2a0826d3e89d624e8b1c5'
            isExternal
          >
