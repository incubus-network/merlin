...
import { fromAssetId, toAssetId } from '@gridironx/caip'
...
export const CONTRACT_ADDRESS_TO_TYPECHAIN_CONTRACT = {
  [ETH_MERLIN_POOL_CONTRACT_ADDRESS]: IUniswapV2Pair__factory,
  [ETH_MERLIN_STAKING_CONTRACT_ADDRESS_V1]: FarmingAbi__factory,
  [ETH_MERLIN_STAKING_CONTRACT_ADDRESS_V2]: FarmingAbi__factory,
  [ETH_MERLIN_STAKING_CONTRACT_ADDRESS_V3]: FarmingAbi__factory,
  [ETH_MERLIN_STAKING_CONTRACT_ADDRESS_V4]: FarmingAbi__factory,
  [ETH_MERLIN_STAKING_CONTRACT_ADDRESS_V5]: FarmingAbi__factory,
  [ETH_MERLIN_STAKING_CONTRACT_ADDRESS_V6]: FarmingAbi__factory,
  [MERLIN_TOKEN_CONTRACT_ADDRESS]: ERC20ABI__factory,
