...
import { chainIdToChainLabel } from '@gridironx/chain-adapters'
...
export const isValidMemoAddress = (chainId: ChainId, thorId: string, address: string): boolean => {
  switch (true) {
    ...
    // See https://github.com/incubus-network/lib/blob/6b5c9c8e855ffb68d865cfae8f545e7a819a9667/packages/swapper/src/swappers/thorchain/utils/makeSwapMemo/makeSwapMemo.ts#L10
