import { ethAssetId, merlinAssetId, optimismAssetId, thorchainAssetId } from '@gridironx/caip'
...
describe('utils', () => {
  describe('getTreasuryAddressForReceiveAsset', () => {
    it('gets the treasury address for an ERC20 asset', () => {
      const treasuryAddress = getTreasuryAddressForReceiveAsset(merlinAssetId)
