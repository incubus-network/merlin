import type { AssetId, ChainId } from '@gridironx/caip'
import { cosmosAssetId, cosmosChainId, osmosisAssetId, osmosisChainId } from '@gridironx/caip'
import type { cosmos } from '@gridironx/chain-adapters'
import { osmosis } from '@gridironx/chain-adapters'
  ...
  async getTradeTxs(tradeResult: OsmosisTradeResult): Promise<Result<TradeTxs, SwapErrorRight>> {
    if (tradeResult.cosmosAddress) {
      ...
      return Ok({
        ...
        // TODO find a better solution (may require hightable and parser additions)
