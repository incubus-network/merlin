...
import { mockMerlinMarketData, mockMerlinPriceHistoryData } from './merlin/merlinMockData'
import {
...
const mockMerlinFindAll = jest.fn().mockImplementation(() => mockMerlinMarketData)
const mockMerlinFindByAssetId = jest.fn().mockImplementation(() => mockMerlinMarketData)
const mockMerlinFindPriceHistoryByAssetId = jest
  .fn()
  .mockImplementation(() => mockMerlinPriceHistoryData)

jest.mock('./merlin/merlin', () => ({
  MerlinMarketService: jest.fn().mockImplementation(() => {
    return {
      findAll: mockMerlinFindAll,
      findByAssetId: mockMerlinFindByAssetId,
      findPriceHistoryByAssetId: mockMerlinFindPriceHistoryByAssetId,
    }
  }),
}))
...
describe('market service', () => {
  ...
  describe('findAll', () => {
    ...
    it('errors if no data found', async () => {
      ...
      mockMerlinFindAll.mockRejectedValueOnce({ error: 'error' })
  ...
  describe('findByAssetId', () => {
    ...
    it('can return null if no data found', async () => {
      ...
      mockMerlinFindByAssetId.mockRejectedValueOnce({ error: 'error' })
  ...
  describe('findPriceHistoryByAssetId', () => {
    ...
    it('can return null if no data found', async () => {
      ...
      mockMerlinFindPriceHistoryByAssetId.mockRejectedValueOnce({ error: 'error' })
