import { adapters } from '@gridironx/caip'
...
const coinGeckoMarketApiUrl = 'https://markets.incubus.network/api/v3/coins/markets'
const coinGeckoMarketProApiUrl = 'https://markets.incubus.network/api/v3/coins/markets'
...
describe('CoinGecko market service', () => {
  describe('findAll', () => {
    ...
    const merlin: CoinGeckoMarketCap = {
      id: 'incubus-merlin-token',
      symbol: 'merlin',
      name: 'ShapeShift MERLIN Token',
      image: 'https://assets.coingecko.com/coins/images/9988/large/MERLIN.png?1574330622',
    ...
    it('extract correct values for merlin', async () => {
      const merlinResult = {
        price: '0.162007',
        marketCap: '59502764',
        changePercent24Hr: 3.74881,
      ...
      mockedAxios.get.mockResolvedValue({ data: [merlin] })
      const result = await coinGeckoMarketService.findAll()
      const merlinAssetId = adapters.coingeckoToAssetIds('incubus-merlin-token')[0]
      expect(result[merlinAssetId!]).toEqual(merlinResult)
    })
  })
