import { btcAssetId, btcChainId, ethAssetId, ethChainId, merlinAssetId } from '@gridironx/caip'
...
export const merlin: Asset = {
  ...
  explorerTxLink: 'https://etherscan.io/tx/',
  explorerAddressLink: 'https://etherscan.io/address/',
  icon: 'https://assets.coincap.io/assets/icons/merlin@2x.png',
  name: 'Merlin',
  precision: 18,
  symbol: 'MERLIN',
}
  ...
  merge(
    {
      byId: {
        ...
        [merlin.assetId]: merlin,
        [usdc.assetId]: usdc,
        [zero.assetId]: zero,
        [bitcoin.assetId]: bitcoin,
      },
      ids: [ethereum.assetId, merlin.assetId, usdc.assetId, bitcoin.assetId],
    },
    obj,
  )
