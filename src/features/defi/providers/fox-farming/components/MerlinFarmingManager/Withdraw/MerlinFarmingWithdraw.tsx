...
type MerlinFarmingWithdrawProps = {
  accountId: AccountId | undefined
  onAccountIdChange: AccountDropdownProps['onChange']
}
export const MerlinFarmingWithdraw: React.FC<MerlinFarmingWithdrawProps> = ({
  accountId,
  ...
  const StepConfig: DefiStepProps = useMemo(() => {
    return {
      [DefiStep.Info]: merlinFarmingOpportunity?.expired
        ? {
        ...
        : {
            ...
            description: translate('defi.steps.withdraw.info.description', {
              asset: merlinFarmingOpportunity?.name,
            }),
            component: ownProps => (
              <Withdraw
                {...ownProps}
    ...
    accountId,
    merlinFarmingOpportunity?.expired,
    merlinFarmingOpportunity?.name,
    handleAccountIdChange,
    translate,
  ])

  if (loading || !merlinFarmingOpportunity)
    return (
