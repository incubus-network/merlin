...
import { ASSET_REFERENCE, toAssetId } from '@gridironx/caip'
...
export const ClaimStatus: React.FC<ClaimStatusProps> = ({ accountId }) => {
  ...
  const refetchMerlinBalances = useCallback(() => {
    if (!accountId) return
  ...
  }, [refetchMerlinBalances, estimatedGas, merlinApi, state, txid])
