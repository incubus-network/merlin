...
type MerlinEmptyProps = {
  assets: Asset[]
  apy: string | undefined
  onClick?: () => void
}

export const MerlinEmpty = ({ assets, apy, onClick }: MerlinEmptyProps) => {
  return (
    <DefiModalContent>
      <EmptyOverview
        assets={assets}
        footer={
          <Button width='full' colorScheme='blue' onClick={onClick}>
            <Text translation='defi.modals.merlinOverview.cta' />
          </Button>
        }
      >
        <Stack direction='row' flexWrap='wrap' spacing={1} justifyContent='center' mb={4}>
          <Text translation='defi.modals.merlinOverview.header' />
        ...
        <Text color='gray.500' translation='defi.modals.merlinOverview.body' />
        <Text color='gray.500' translation='defi.modals.merlinOverview.rewards' />
      </EmptyOverview>
    </DefiModalContent>
  )
}
