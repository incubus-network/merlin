...
import type { UserUndelegation } from 'state/slices/opportunitiesSlice/resolvers/merlin/types'
...
export const WithdrawCard = ({ asset, undelegation, canClaimWithdraw }: WithdrawCardProps) => {
  ...
  return (
    <Stack px={8} py={6}>
      <Text fontWeight='medium' translation='defi.modals.merlinOverview.withdrawals' />
      {!hasClaim ? (
        <Text color='gray.500' translation='defi.modals.merlinOverview.emptyWithdraws' />
      ) : (
        <Button
          variant='input'
          width='full'
          ...
          >
            ...
            {isUndelegationAvailable ? (
              ...
              <Text
                ...
                lineHeight='shorter'
                translation={[
                  'defi.modals.merlinOverview.availableDate',
