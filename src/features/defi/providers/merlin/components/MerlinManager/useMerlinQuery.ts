import { ASSET_REFERENCE, fromAssetId, toAssetId } from '@gridironx/caip'
import type {
  DefiParams,
  DefiQueryParams,
...
export const useMerlinQuery = () => {
  ...
  // The Staking asset is one of the only underlying Asset Ids MERLIN
