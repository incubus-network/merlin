import { btcAssetId, ethAssetId, merlinAssetId } from '@gridironx/caip'
      ...
      describe('ethereum', () => {
        it('should update state', () => {
          ...
          const ethAccount = mockEthAccount({
            chainSpecific: {
              nonce: 1,
              tokens: [mockEthToken({ balance: '1', assetId: merlinAssetId })],
            },
          })
          ...
          const { ethAccount, ethAccount2, btcAccount } = mockEthAndBtcAccounts({
            ethAccountObj: {
              ...
              chainSpecific: {
                nonce: 5,
                tokens: [
                  mockEthToken({ balance: '42729243327349401946', assetId: merlinAssetId }),
            ...
            ethAccount2Obj: {
              ...
              chainSpecific: {
                nonce: 5,
                tokens: [
                  mockEthToken({ balance: '40729243327349401946', assetId: merlinAssetId }),
                  mockEthToken({ balance: '41208456', assetId: usdcAssetId }),
                  mockEthToken({ balance: '8178352', assetId: yvusdcAssetId }),
                ],
              },
            ...
            ethAccountObj: {
              ...
              chainSpecific: {
                ...
                tokens: [
                  ...
                  mockEthToken({ balance: '40729243327349401958', assetId: merlinAssetId }),
  ...
  describe('selectors', () => {
    describe('selectPortfolioAllocationPercentByFilter', () => {
      ...
      it('should return 0 for allocation if no market data is available', () => {
        ...
        const merlinMarketData = mockMarketData({ price: null })
    ...
    describe('selectPortfolioFiatAccountBalance', () => {
      ...
      it('can select crypto fiat account balance', () => {
        ...
        const merlinMarketData = mockMarketData({ price: '10' })
    ...
    describe('selectPortfolioAssetIdsByAccountIdExcludeFeeAsset', () => {
      ...
      const { ethAccount, ethAccount2, ethAccountId, ethAccount2Id } = mockEthAndBtcAccounts({
        ethAccountObj: {
          ...
          chainSpecific: {
            tokens: [
              mockEthToken({ balance: '1000000000000000000', assetId: merlinAssetId }),
      ...
      it('should return assetIds (excluding fee assets, ie Ethereum) of a given account, sorted by fiat value', () => {
        const expected = [zeroAssetId, merlinAssetId, usdcAssetId]
    ...
    describe('selectPortfolioAccountRows', () => {
      ...
      const { ethAccount } = mockEthAndBtcAccounts({
        ethAccountObj: {
          ...
          chainSpecific: {
            tokens: [
              mockEthToken({ balance: '123456123456315537', assetId: merlinAssetId }),
      ...
      // dispatch market data
      const ethMarketData = mockMarketData({ price: '1000' })
      const merlinMarketData = mockMarketData({ price: '31.39' })
      const usdcMarketData = mockMarketData({ price: '1' })
