...
describe('trimWithEndEllipsis', () => {
  it('should trim the description according to the max number of characters', () => {
    const LongMerlinDescription =
      'MERLIN is an ERC-20 token created by ShapeShift which serves as the governance token for the ShapeShift DAO, token holders can vote on proposals relating to the operation and treasury of the DAO. The token supports'
    const ExpectedTrimmedMerlinDescription =
      'MERLIN is an ERC-20 token created by ShapeShift which serves as the governance token for the ShapeShift DAO, token holders can vote on proposals relating to the operation and treasury of the DAO...'
    ...
    expect(trimWithEndEllipsis(LongMerlinDescription)).toEqual(LongMerlinDescription)
    ...
    expect(trimWithEndEllipsis(LongMerlinDescription, 191)).toEqual(ExpectedTrimmedMerlinDescription)
  })
})
