...
import {
  ethMerlinStakingMetadataResolver,
  ethMerlinStakingOpportunityIdsResolver,
  ethMerlinStakingUserDataResolver,
} from './resolvers/ethMerlinStaking'
import {
  merlinStakingOpportunitiesMetadataResolver,
  merlinStakingOpportunitiesUserDataResolver,
  merlinStakingOpportunityIdsResolver,
} from './resolvers/merlin'
import {
...
export const DefiProviderToMetadataResolverByDeFiType = {
  [`${DefiProvider.EthMerlinStaking}`]: {
    [`${DefiType.Staking}`]: ethMerlinStakingMetadataResolver,
  },
}
...
export const DefiProviderToOpportunitiesMetadataResolverByDeFiType = {
  ...
  [`${DefiProvider.ShapeShift}`]: {
    [`${DefiType.Staking}`]: merlinStakingOpportunitiesMetadataResolver,
  },
}
...
export const DefiProviderToOpportunitiesUserDataResolverByDeFiType = {
  ...
  [`${DefiProvider.ShapeShift}`]: {
    [`${DefiType.Staking}`]: merlinStakingOpportunitiesUserDataResolver,
  },
  [`${DefiProvider.ThorchainSavers}`]: {
...
export const DefiProviderToOpportunityIdsResolverByDeFiType = {
  ...
  [`${DefiProvider.EthMerlinStaking}`]: {
    [`${DefiType.Staking}`]: ethMerlinStakingOpportunityIdsResolver,
  },
  [`${DefiProvider.Idle}`]: {
  ...
  [`${DefiProvider.ShapeShift}`]: {
    [`${DefiType.Staking}`]: merlinStakingOpportunityIdsResolver,
  },
  [`${DefiProvider.CosmosSdk}`]: {
...
export const DefiProviderToUserDataResolverByDeFiType = {
  ...
  [`${DefiProvider.EthMerlinStaking}`]: {
    [`${DefiType.Staking}`]: ethMerlinStakingUserDataResolver,
  },
}
