import { ethAssetId, fromAssetId, toAssetId } from '@gridironx/caip'
...
import { merlinEthLpAssetIds } from '../../constants'
import type {
...
export const uniV2LpLpOpportunityIdsResolver = ({
  ...
  if (!DynamicLpAssets) return Promise.resolve({ data: [...merlinEthLpAssetIds] })
