...
import { merlinEthLpAssetId, merlinEthPair, merlinEthStakingAssetIdV5 } from '../constants'
import {
  catpuccinoAccountId,
  fauxmesAccountId,
  gomesAccountId,
...
describe('opportunitiesSlice selectors', () => {
  ...
  describe('selectUserStakingOpportunityByUserStakingId', () => {
    const mockOpportunityMetadata: OpportunityMetadata = {
      ...
      underlyingAssetIds: [merlinAssetId, ethAssetId] as [AssetId, AssetId],
    ...
    const mockOpportunityMetadataTwo: OpportunityMetadata = {
      // The LP token AssetId
      assetId: merlinEthStakingAssetIdV5,
      id: merlinEthStakingAssetIdV5 as OpportunityId,
      name: 'ETH/MERLIN Farming',
