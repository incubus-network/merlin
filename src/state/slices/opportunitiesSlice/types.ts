...
export enum DefiProvider {
  ...
  EthMerlinStaking = 'ETH/MERLIN Staking',
  UniV2 = 'Uniswap V2',
...
export type UserStakingOpportunity =
  ...
  | MerlinSpecificUserStakingOpportunity
...
type EarnDefiTypeBase = {
  ...
  highestBalanceAccountAddress?: string // MERLIN/ETH specific, let's change it to accountId across the line if we need it for other opportunities
}
