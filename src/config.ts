...
const validators = {
  ...
  REACT_APP_HIGHTABLE_ETHEREUM_HTTP_URL: url(),
  REACT_APP_HIGHTABLE_ETHEREUM_WS_URL: url(),
  REACT_APP_HIGHTABLE_AVALANCHE_HTTP_URL: url(),
  REACT_APP_HIGHTABLE_AVALANCHE_WS_URL: url(),
  REACT_APP_HIGHTABLE_OPTIMISM_HTTP_URL: url(),
  REACT_APP_HIGHTABLE_OPTIMISM_WS_URL: url(),
  REACT_APP_HIGHTABLE_BNBSMARTCHAIN_HTTP_URL: url(),
  REACT_APP_HIGHTABLE_BNBSMARTCHAIN_WS_URL: url(),
  REACT_APP_HIGHTABLE_POLYGON_HTTP_URL: url(),
  REACT_APP_HIGHTABLE_POLYGON_WS_URL: url(),
  REACT_APP_HIGHTABLE_GNOSIS_HTTP_URL: url(),
  REACT_APP_HIGHTABLE_GNOSIS_WS_URL: url(),
  REACT_APP_HIGHTABLE_BITCOIN_HTTP_URL: url(),
  REACT_APP_HIGHTABLE_BITCOIN_WS_URL: url(),
  REACT_APP_HIGHTABLE_BITCOINCASH_HTTP_URL: url(),
  REACT_APP_HIGHTABLE_BITCOINCASH_WS_URL: url(),
  REACT_APP_HIGHTABLE_DOGECOIN_HTTP_URL: url(),
  REACT_APP_HIGHTABLE_DOGECOIN_WS_URL: url(),
  REACT_APP_HIGHTABLE_LITECOIN_HTTP_URL: url(),
  REACT_APP_HIGHTABLE_LITECOIN_WS_URL: url(),
  REACT_APP_HIGHTABLE_COSMOS_HTTP_URL: url(),
  REACT_APP_HIGHTABLE_COSMOS_WS_URL: url(),
  REACT_APP_HIGHTABLE_OSMOSIS_HTTP_URL: url(),
  REACT_APP_HIGHTABLE_OSMOSIS_WS_URL: url(),
  REACT_APP_HIGHTABLE_THORCHAIN_HTTP_URL: url(),
  REACT_APP_HIGHTABLE_THORCHAIN_WS_URL: url(),
  ...
  REACT_APP_COSMOS_NODE_URL: url({
    default: 'https://dev-daemon.osmosis.incubus.network',
  }),
  REACT_APP_OSMOSIS_NODE_URL: url({
    default: 'https://dev-daemon.cosmos.incubus.network',
  }),
  ...
  REACT_APP_OSMOSIS_LCD_BASE_URL: url({
    default: 'https://daemon.osmosis.incubus.network/',
  }),
  ...
  REACT_APP_SNAPSHOT_BASE_URL: url({
    default: 'https://snapshot.org/#/incubusdao.eth',
  }),
  REACT_APP_FEATURE_MIXPANEL: bool({ default: false }),
  REACT_APP_FEATURE_MERLIN_BOND_CTA: bool({ default: false }),
