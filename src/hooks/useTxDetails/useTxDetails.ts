...
import type { TxTransfer } from '@gridironx/chain-adapters'
import type { MarketData } from '@shapeshiftoss/types'
import type * as hightable from '@gridironx/hightable-client'
...
export type Fee = hightable.Fee & { asset: Asset; marketData: MarketData }

export type TxType = hightable.TransferType | hightable.TradeType | 'method' | 'unknown'
