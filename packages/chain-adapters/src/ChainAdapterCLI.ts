...
const btcChainAdapter = new BitcoinChainAdapter({
  providers: {
    ws: new hightable.ws.Client<hightable.bitcoin.Tx>('wss://dev-api.bitcoin.shapeshift.com'),
    http: new hightable.bitcoin.V1Api(
      new hightable.bitcoin.Configuration({ basePath: 'https://dev-api.bitcoin.shapeshift.com' }),
    ),
  },
  coinName: 'Bitcoin',
})
...
const dogeChainAdapter = new DogecoinChainAdapter({
  providers: {
    ws: new hightable.ws.Client<hightable.dogecoin.Tx>('wss://dev-api.dogecoin.shapeshift.com'),
    http: new hightable.dogecoin.V1Api(
      new hightable.dogecoin.Configuration({ basePath: 'https://dev-api.dogecoin.shapeshift.com' }),
    ),
  },
  coinName: 'Dogecoin',
})
...
const ethChainAdapter = new EthereumChainAdapter({
  providers: {
    ws: new hightable.ws.Client<hightable.ethereum.Tx>('wss://dev-api.ethereum.shapeshift.com'),
    http: new hightable.ethereum.V1Api(
      new hightable.ethereum.Configuration({ basePath: 'https://dev-api.ethereum.shapeshift.com' }),
    ),
  },
...
const cosmosChainAdapter = new CosmosChainAdapter({
  providers: {
    ws: new hightable.ws.Client<hightable.cosmossdk.Tx>('wss://dev-api.cosmos.shapeshift.com'),
    http: new hightable.cosmos.V1Api(
      new hightable.cosmos.Configuration({ basePath: 'https://dev-api.cosmos.shapeshift.com' }),
    ),
  },
  coinName: 'Cosmos',
})
...
const osmosisChainAdapter = new OsmosisChainAdapter({
  providers: {
    ws: new hightable.ws.Client<hightable.cosmossdk.Tx>('wss://dev-api.osmosis.shapeshift.com'),
    http: new hightable.osmosis.V1Api(
      new hightable.osmosis.Configuration({ basePath: 'https://dev-api.osmosis.shapeshift.com' }),
    ),
  },
  coinName: 'Osmosis',
})
...
const thorchainChainAdapter = new ThorchainChainAdapter({
  providers: {
    ws: new hightable.ws.Client<hightable.cosmossdk.Tx>('wss://dev-api.thorchain.shapeshift.com'),
...
const testEthereum = async (wallet: NativeHDWallet, broadcast = false) => {
  ...
  try {
    ...
    //    gasPrice: '0',
    //    gasLimit: '0',
    //    tokenContractAddress: '0xc770eefad204b5180df6a14ee197d99d808ee52d' // MERLIN
    //  }
    //})
