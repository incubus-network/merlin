 ...
 * @group unit
 */
import { ASSET_REFERENCE, avalancheAssetId, avalancheChainId, fromChainId } from '@gridironx/caip'
...
const makeChainAdapterArgs = (overrideArgs?: {
  providers?: { http: hightable.avalanche.V1Api }
  chainId?: EvmChainId
}): ChainAdapterArgs<hightable.avalanche.V1Api> =>
  merge(
    {
      providers: {
        http: {} as hightable.avalanche.V1Api,
        ws: {} as hightable.ws.Client<hightable.avalanche.Tx>,
      },
      rpcUrl: '',
    },
    overrideArgs,
...
describe('AvalancheChainAdapter', () => {
  ...
  describe('getFeeData', () => {
    it('should return current network fees', async () => {
      ...
      } as unknown as hightable.avalanche.V1Api
