import { ASSET_REFERENCE, AssetId, ethAssetId } from '@gridironx/caip'
...
export class ChainAdapter extends EvmBaseAdapter<KnownChainIds.EthereumMainnet> {
  ...
  private readonly api: hightable.ethereum.V1Api

  constructor(args: ChainAdapterArgs<hightable.ethereum.V1Api>) {
    super({
    ...
    this.parser = new hightable.ethereum.TransactionParser({
