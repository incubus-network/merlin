 ...
 * @group unit
 */
import { ASSET_REFERENCE, bscAssetId, bscChainId, fromChainId } from '@gridironx/caip'
import hightable from '@gridironx/hightable-client'
...
const makeChainAdapterArgs = (overrideArgs?: {
  providers?: { http: hightable.bnbsmartchain.V1Api }
  chainId?: EvmChainId
}): ChainAdapterArgs<hightable.bnbsmartchain.V1Api> =>
  merge(
    {
      providers: {
        http: {} as hightable.bnbsmartchain.V1Api,
        ws: {} as hightable.ws.Client<hightable.bnbsmartchain.Tx>,
      },
      rpcUrl: '',
    },
    overrideArgs,
...
describe('BscChainAdapter', () => {
  ...
  describe('getFeeData', () => {
    it('should return current network fees', async () => {
      ...
      } as unknown as hightable.bnbsmartchain.V1Api
