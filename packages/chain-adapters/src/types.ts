import { ChainId } from '@gridironx/caip'
...
export type TransferType = hightable.TransferType
export type TradeType = hightable.TradeType

export type TxMetadata = hightable.evm.TxMetadata | hightable.cosmossdk.TxMetadata

export type Transaction = Omit<hightable.StandardTx, 'transfers'> & {
